...
const HeroSection = ({ mode }) => {
  ...
  // Vars
  const dashboardImageLight = 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=800&q=80'
  const dashboardImageDark = 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=800&q=80'
